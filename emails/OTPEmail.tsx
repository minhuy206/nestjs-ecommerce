    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Contact&nbsp;
          <Link href={`mailto:${envConfig.ADMIN_EMAIL}`} style={link}>
            {envConfig.ADMIN_EMAIL}
          </Link>&nbsp;if you did not request this code.
        </Text>
      </Container>
      <Text style={footer}>Securely powered by <span style={brand}>{envConfig.ADMIN_NAME}</span>.</Text>
    </Body>
  </Html>
);
